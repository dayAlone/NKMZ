...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
		<a class="search-page__title clearfix" href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>
		<?if(strlen($arItem["BODY_FORMATED"])>0):?>
		<p class="search-page__text"><?echo strip_tags(html_entity_decode($arItem["BODY_FORMATED"]))?></p>
		<?endif;?>
